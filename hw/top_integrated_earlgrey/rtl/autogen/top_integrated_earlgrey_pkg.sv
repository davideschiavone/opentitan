...
package top_integrated_earlgrey_pkg;
  ...
  typedef enum int unsigned {
    ...
    TopIntegratedEarlgreyAlertPeripheralSensorCtrlAon = 24,
    TopIntegratedEarlgreyAlertPeripheralSramCtrlRetAon = 25,
    TopIntegratedEarlgreyAlertPeripheralFlashCtrl = 26,
    TopIntegratedEarlgreyAlertPeripheralRvDm = 27,
    TopIntegratedEarlgreyAlertPeripheralRvPlic = 28,
    TopIntegratedEarlgreyAlertPeripheralAes = 29,
    TopIntegratedEarlgreyAlertPeripheralHmac = 30,
    TopIntegratedEarlgreyAlertPeripheralKmac = 31,
    TopIntegratedEarlgreyAlertPeripheralOtbn = 32,
    TopIntegratedEarlgreyAlertPeripheralKeymgr = 33,
    TopIntegratedEarlgreyAlertPeripheralCsrng = 34,
    TopIntegratedEarlgreyAlertPeripheralEntropySrc = 35,
    TopIntegratedEarlgreyAlertPeripheralEdn0 = 36,
    TopIntegratedEarlgreyAlertPeripheralEdn1 = 37,
    TopIntegratedEarlgreyAlertPeripheralSramCtrlMain = 38,
    TopIntegratedEarlgreyAlertPeripheralRomCtrl = 39,
    TopIntegratedEarlgreyAlertPeripheralRvCoreIbex = 40,
  ...
  typedef enum int unsigned {
    ...
    TopIntegratedEarlgreyAlertIdSensorCtrlAonRecovAlert = 32,
    TopIntegratedEarlgreyAlertIdSensorCtrlAonFatalAlert = 33,
    TopIntegratedEarlgreyAlertIdSramCtrlRetAonFatalError = 34,
    TopIntegratedEarlgreyAlertIdFlashCtrlRecovErr = 35,
    TopIntegratedEarlgreyAlertIdFlashCtrlFatalStdErr = 36,
    TopIntegratedEarlgreyAlertIdFlashCtrlFatalErr = 37,
    TopIntegratedEarlgreyAlertIdFlashCtrlFatalPrimFlashAlert = 38,
    TopIntegratedEarlgreyAlertIdFlashCtrlRecovPrimFlashAlert = 39,
    TopIntegratedEarlgreyAlertIdRvDmFatalFault = 40,
    TopIntegratedEarlgreyAlertIdRvPlicFatalFault = 41,
    TopIntegratedEarlgreyAlertIdAesRecovCtrlUpdateErr = 42,
    TopIntegratedEarlgreyAlertIdAesFatalFault = 43,
    TopIntegratedEarlgreyAlertIdHmacFatalFault = 44,
    TopIntegratedEarlgreyAlertIdKmacRecovOperationErr = 45,
    TopIntegratedEarlgreyAlertIdKmacFatalFaultErr = 46,
    TopIntegratedEarlgreyAlertIdOtbnFatal = 47,
    TopIntegratedEarlgreyAlertIdOtbnRecov = 48,
    TopIntegratedEarlgreyAlertIdKeymgrRecovOperationErr = 49,
    TopIntegratedEarlgreyAlertIdKeymgrFatalFaultErr = 50,
    TopIntegratedEarlgreyAlertIdCsrngRecovAlert = 51,
    TopIntegratedEarlgreyAlertIdCsrngFatalAlert = 52,
    TopIntegratedEarlgreyAlertIdEntropySrcRecovAlert = 53,
    TopIntegratedEarlgreyAlertIdEntropySrcFatalAlert = 54,
    TopIntegratedEarlgreyAlertIdEdn0RecovAlert = 55,
    TopIntegratedEarlgreyAlertIdEdn0FatalAlert = 56,
    TopIntegratedEarlgreyAlertIdEdn1RecovAlert = 57,
    TopIntegratedEarlgreyAlertIdEdn1FatalAlert = 58,
    TopIntegratedEarlgreyAlertIdSramCtrlMainFatalError = 59,
    TopIntegratedEarlgreyAlertIdRomCtrlFatal = 60,
    TopIntegratedEarlgreyAlertIdRvCoreIbexFatalSwErr = 61,
    TopIntegratedEarlgreyAlertIdRvCoreIbexRecovSwErr = 62,
    TopIntegratedEarlgreyAlertIdRvCoreIbexFatalHwErr = 63,
    TopIntegratedEarlgreyAlertIdRvCoreIbexRecovHwErr = 64,
  ...
  typedef enum int unsigned {
    ...
    TopIntegratedEarlgreyIrqIdSensorCtrlAonIoStatusChange = 158,
    TopIntegratedEarlgreyIrqIdSensorCtrlAonInitStatusChange = 159,
    TopIntegratedEarlgreyIrqIdFlashCtrlProgEmpty = 160,
    TopIntegratedEarlgreyIrqIdFlashCtrlProgLvl = 161,
    TopIntegratedEarlgreyIrqIdFlashCtrlRdFull = 162,
    TopIntegratedEarlgreyIrqIdFlashCtrlRdLvl = 163,
    TopIntegratedEarlgreyIrqIdFlashCtrlOpDone = 164,
    TopIntegratedEarlgreyIrqIdFlashCtrlCorrErr = 165,
    TopIntegratedEarlgreyIrqIdHmacHmacDone = 166,
    TopIntegratedEarlgreyIrqIdHmacFifoEmpty = 167,
    TopIntegratedEarlgreyIrqIdHmacHmacErr = 168,
    TopIntegratedEarlgreyIrqIdKmacKmacDone = 169,
    TopIntegratedEarlgreyIrqIdKmacFifoEmpty = 170,
    TopIntegratedEarlgreyIrqIdKmacKmacErr = 171,
    TopIntegratedEarlgreyIrqIdOtbnDone = 172,
    TopIntegratedEarlgreyIrqIdKeymgrOpDone = 173,
    TopIntegratedEarlgreyIrqIdCsrngCsCmdReqDone = 174,
    TopIntegratedEarlgreyIrqIdCsrngCsEntropyReq = 175,
    TopIntegratedEarlgreyIrqIdCsrngCsHwInstExc = 176,
    TopIntegratedEarlgreyIrqIdCsrngCsFatalErr = 177,
    TopIntegratedEarlgreyIrqIdEntropySrcEsEntropyValid = 178,
    TopIntegratedEarlgreyIrqIdEntropySrcEsHealthTestFailed = 179,
    TopIntegratedEarlgreyIrqIdEntropySrcEsObserveFifoReady = 180,
    TopIntegratedEarlgreyIrqIdEntropySrcEsFatalErr = 181,
    TopIntegratedEarlgreyIrqIdEdn0EdnCmdReqDone = 182,
    TopIntegratedEarlgreyIrqIdEdn0EdnFatalErr = 183,
    TopIntegratedEarlgreyIrqIdEdn1EdnCmdReqDone = 184,
    TopIntegratedEarlgreyIrqIdEdn1EdnFatalErr = 185,
