...
module chip_integrated_earlgrey_cw340 #(
...
// otherwise Verilator / FPGA will hang.
  ...
  assign clk_trans_idle = top_integrated_earlgrey.clkmgr_aon_idle[trigger_sel];
...
endmodule : chip_integrated_earlgrey_cw340
