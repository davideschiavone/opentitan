...
module xbar_peri (
  ...
  input  tlul_pkg::tl_h2d_t tl_host_mailbox_i,
  output tlul_pkg::tl_d2h_t tl_host_mailbox_o,
  ...
  output tlul_pkg::tl_h2d_t tl_host_ctrl_o,
  input  tlul_pkg::tl_d2h_t tl_host_ctrl_i,
  output tlul_pkg::tl_h2d_t tl_mailbox_o,
  input  tlul_pkg::tl_d2h_t tl_mailbox_i,
  ...
  tl_h2d_t tl_s1n_33_ds_h2d [1];
  tl_d2h_t tl_s1n_33_ds_d2h [1];

  // Create steering signal
  logic [0:0] dev_sel_s1n_33;
  ...
  assign tl_rv_timer_o = tl_s1n_31_ds_h2d[10];
  assign tl_s1n_31_ds_d2h[10] = tl_rv_timer_i;

  assign tl_pwrmgr_aon_o = tl_s1n_31_ds_h2d[11];
  assign tl_s1n_31_ds_d2h[11] = tl_pwrmgr_aon_i;

  assign tl_rstmgr_aon_o = tl_s1n_31_ds_h2d[12];
  assign tl_s1n_31_ds_d2h[12] = tl_rstmgr_aon_i;

  assign tl_clkmgr_aon_o = tl_s1n_31_ds_h2d[13];
  assign tl_s1n_31_ds_d2h[13] = tl_clkmgr_aon_i;

  assign tl_pinmux_aon_o = tl_s1n_31_ds_h2d[14];
  assign tl_s1n_31_ds_d2h[14] = tl_pinmux_aon_i;

  assign tl_otp_ctrl__core_o = tl_s1n_31_ds_h2d[15];
  assign tl_s1n_31_ds_d2h[15] = tl_otp_ctrl__core_i;

  assign tl_otp_macro__prim_o = tl_s1n_31_ds_h2d[16];
  assign tl_s1n_31_ds_d2h[16] = tl_otp_macro__prim_i;

  assign tl_lc_ctrl__regs_o = tl_s1n_31_ds_h2d[17];
  assign tl_s1n_31_ds_d2h[17] = tl_lc_ctrl__regs_i;

  assign tl_sensor_ctrl_aon_o = tl_s1n_31_ds_h2d[18];
  assign tl_s1n_31_ds_d2h[18] = tl_sensor_ctrl_aon_i;

  assign tl_alert_handler_o = tl_s1n_31_ds_h2d[19];
  assign tl_s1n_31_ds_d2h[19] = tl_alert_handler_i;

  assign tl_ast_o = tl_s1n_31_ds_h2d[20];
  assign tl_s1n_31_ds_d2h[20] = tl_ast_i;

  assign tl_host_ctrl_o = tl_s1n_31_ds_h2d[21];
  assign tl_s1n_31_ds_d2h[21] = tl_host_ctrl_i;

  assign tl_sm1_32_us_h2d[0] = tl_s1n_31_ds_h2d[22];
  assign tl_s1n_31_ds_d2h[22] = tl_sm1_32_us_d2h[0];

  assign tl_sram_ctrl_ret_aon__ram_o = tl_s1n_31_ds_h2d[23];
  assign tl_s1n_31_ds_d2h[23] = tl_sram_ctrl_ret_aon__ram_i;

  assign tl_sram_ctrl_ret_aon__regs_o = tl_s1n_31_ds_h2d[24];
  assign tl_s1n_31_ds_d2h[24] = tl_sram_ctrl_ret_aon__regs_i;

  assign tl_aon_timer_aon_o = tl_s1n_31_ds_h2d[25];
  assign tl_s1n_31_ds_d2h[25] = tl_aon_timer_aon_i;

  assign tl_adc_ctrl_aon_o = tl_s1n_31_ds_h2d[26];
  assign tl_s1n_31_ds_d2h[26] = tl_adc_ctrl_aon_i;

  assign tl_sysrst_ctrl_aon_o = tl_s1n_31_ds_h2d[27];
  assign tl_s1n_31_ds_d2h[27] = tl_sysrst_ctrl_aon_i;

  assign tl_pwm_aon_o = tl_s1n_31_ds_h2d[28];
  assign tl_s1n_31_ds_d2h[28] = tl_pwm_aon_i;

  assign tl_sm1_32_us_h2d[1] = tl_s1n_33_ds_h2d[0];
  assign tl_s1n_33_ds_d2h[0] = tl_sm1_32_us_d2h[1];

  assign tl_s1n_31_us_h2d = tl_main_i;
  assign tl_main_o = tl_s1n_31_us_d2h;

  assign tl_mailbox_o = tl_sm1_32_ds_h2d;
  assign tl_sm1_32_ds_d2h = tl_mailbox_i;

  assign tl_s1n_33_us_h2d = tl_host_mailbox_i;
  assign tl_host_mailbox_o = tl_s1n_33_us_d2h;
  ...
  always_comb begin
    ...
    if ((tl_s1n_31_us_h2d.a_address &
      ...
      dev_sel_s1n_31 = 5'd20;
                  ...
                  ~(ADDR_MASK_HOST_CTRL)) == ADDR_SPACE_HOST_CTRL) begin
      dev_sel_s1n_31 = 5'd21;

    end else if ((tl_s1n_31_us_h2d.a_address &
                  ~(ADDR_MASK_MAILBOX)) == ADDR_SPACE_MAILBOX) begin
