...
`ifndef GATE_LEVEL
  ...
  bind xbar_peri tlul_assert #(.EndpointType("Host")) tlul_assert_device_otp_macro__prim (
    .clk_i  (clk_peri_i),
    .rst_ni (rst_peri_ni),
  ...
  bind xbar_peri tlul_assert #(.EndpointType("Host")) tlul_assert_device_host_ctrl (
    .clk_i  (clk_peri_i),
    .rst_ni (rst_peri_ni),
    .h2d    (tl_host_ctrl_o),
    .d2h    (tl_host_ctrl_i)
