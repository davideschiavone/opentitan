...
# Expected output
EXPECT_USB=hw/top_integrated_earlgrey/util/opentitan_earlgrey_usbdev_expected-usb
EXPECT_UART=hw/top_integrated_earlgrey/util/opentitan_earlgrey_usbdev_expected-uart
