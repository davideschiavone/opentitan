...
## set_property KEEP_HIERARCHY TRUE [get_cells top_integrated_earlgrey/u_flash_eflash/gen_flash_banks[*].i_core/u_scramble/u_cipher]
## set_multicycle_path -setup 2 -through [get_pins -of_objects [get_cells top_integrated_earlgrey/u_flash_eflash/gen_flash_banks[*].i_core/u_scramble/u_cipher]]
## set_multicycle_path -hold 1  -through [get_pins -of_objects [get_cells top_integrated_earlgrey/u_flash_eflash/gen_flash_banks[*].i_core/u_scramble/u_cipher]]
...
# See hw/top_integrated_earlgrey/data/top_integrated_earlgrey.hjson['pinout']['pads']
#
