...
module xbar_peri (
  ...
  assign tl_pwrmgr_aon_o = tl_s1n_29_ds_h2d[11];
  assign tl_s1n_29_ds_d2h[11] = tl_pwrmgr_aon_i;

  assign tl_rstmgr_aon_o = tl_s1n_29_ds_h2d[12];
  assign tl_s1n_29_ds_d2h[12] = tl_rstmgr_aon_i;

  assign tl_clkmgr_aon_o = tl_s1n_29_ds_h2d[13];
  assign tl_s1n_29_ds_d2h[13] = tl_clkmgr_aon_i;

  assign tl_pinmux_aon_o = tl_s1n_29_ds_h2d[14];
  assign tl_s1n_29_ds_d2h[14] = tl_pinmux_aon_i;

  assign tl_otp_ctrl__core_o = tl_s1n_29_ds_h2d[15];
  assign tl_s1n_29_ds_d2h[15] = tl_otp_ctrl__core_i;

  assign tl_otp_macro__prim_o = tl_s1n_29_ds_h2d[16];
  assign tl_s1n_29_ds_d2h[16] = tl_otp_macro__prim_i;

  assign tl_lc_ctrl__regs_o = tl_s1n_29_ds_h2d[17];
  assign tl_s1n_29_ds_d2h[17] = tl_lc_ctrl__regs_i;

  assign tl_sensor_ctrl_aon_o = tl_s1n_29_ds_h2d[18];
  assign tl_s1n_29_ds_d2h[18] = tl_sensor_ctrl_aon_i;

  assign tl_alert_handler_o = tl_s1n_29_ds_h2d[19];
  assign tl_s1n_29_ds_d2h[19] = tl_alert_handler_i;

  assign tl_ast_o = tl_s1n_29_ds_h2d[20];
  assign tl_s1n_29_ds_d2h[20] = tl_ast_i;

  assign tl_host_ctrl_o = tl_s1n_29_ds_h2d[21];
  assign tl_s1n_29_ds_d2h[21] = tl_host_ctrl_i;
