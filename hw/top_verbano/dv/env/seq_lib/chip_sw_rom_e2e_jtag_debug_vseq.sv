...
class chip_sw_rom_e2e_jtag_debug_vseq extends chip_sw_base_vseq;
  ...
  task test_chip_mem_access();
    ...
    addr_range_t sram_main = '{
        start_addr: top_verbano_pkg::TOP_VERBANO_SRAM_CTRL_MAIN_RAM_BASE_ADDR,
        end_addr: top_verbano_pkg::TOP_VERBANO_SRAM_CTRL_MAIN_RAM_BASE_ADDR +
                  top_verbano_pkg::TOP_VERBANO_SRAM_CTRL_MAIN_RAM_SIZE_BYTES - 1

    };
    addr_range_t sram_ret = '{
        start_addr: top_verbano_pkg::TOP_VERBANO_SRAM_CTRL_RET_AON_RAM_BASE_ADDR,
        end_addr: top_verbano_pkg::TOP_VERBANO_SRAM_CTRL_RET_AON_RAM_BASE_ADDR +
                  top_verbano_pkg::TOP_VERBANO_SRAM_CTRL_RET_AON_RAM_SIZE_BYTES - 1
